...
```bash
git clone https://github.com/arun-kumar-reddy-vemula/creditCardFraudDetection.git
...
**About the Developer**
Arun is an AI/ML Engineer with over 5 years of experience building practical machine learning solutions for autonomous systems, fraud detection, and industrial IoT. He specializes in end-to-end MLOps, focusing on deploying scalable models and building automated pipelines that bridge the gap between development and production.